<div class="{{ $block->classes }}" style="{{ $block->inlineStyle }}">
  @if ($portfolios)
  <h3 class="portfolio--grid__header p-[116px]">
    Zobacz inne realizacje
      </h3>
      <div id="portfolioGrid" class="portfolio--grid md:mb-[116px] grid grid-cols-1 border-collapse md:grid-cols-2 xl:grid-cols-3 justify-center align-center  border-t-black ">
