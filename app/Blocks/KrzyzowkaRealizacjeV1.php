...
class KrzyzowkaRealizacjeV1 extends Block
{
    /**
     * The block name.
     *
     * @var string
     */
    public $name = 'Krzyzowka Realizacje V1';
     ...
     * @var string
     */
    public $description = 'A simple Krzyzowka Realizacje V1 block.';
    ...
    public $template = [
        ...
        'core/paragraph' => ['placeholder' => 'Welcome to the Krzyzowka Realizacje V1 block.'],
    ];
